                ...
                <div className="input-group-append">
                  ...
                  <div className="sort-menu dropdown-menu dropdown-menu-right">
                    <button className={
                        ...
                        onClick = {
                            e=> this.props.changeOrder('petName', this.props.orderDir)
                        }
                    href="#">
                      Pet Name
                    </button>
                    <button className={
                        ...
                        onClick = {
                            e=> this.props.changeOrder('aptDate', this.props.orderDir)
                        }
                    href="#">
                      Date
                    </button>
                    <button className={
                        ...
                        onClick = {
                            e=> this.props.changeOrder('ownerName', this.props.orderDir)
                        }
                    href="#">
                      Owner
                    </button>
                    ...
                    <button className={
                        ...
                        onClick = {
                            e=> this.props.changeOrder(this.props.orderBy, "asc")
                        }
                    href="#">
                      Asc
                    </button>
